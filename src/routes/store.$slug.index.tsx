...
function StoreCategoryIndex() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
      ...
      <ItemLightboxGrid items={cat.items.slice(0, 10)} categorySlug={cat.slug} categoryName={cat.name} showPrice hoverSwap linkToVariants fancy />
    </section>
  );
}
